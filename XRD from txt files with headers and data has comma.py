...
file_path = r'E:\XRD\2023\mki\Yitang sample from 25-35 degree time 100 s.txt'
...
drop_line_positions = [29, 45]
drop_line_height = 100  # Customize the height of the drop lines
